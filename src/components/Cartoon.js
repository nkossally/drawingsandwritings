...
const Cartoon = () => {
  ...
  return (
    <div class="cartoons-container full-height vertically-centered below-nav-bar">
      ...
      {comicNumber === 43 && (
        <img src={comic_43} alt="comic" className="comic" key={"cartoon 43.png"} />
      )}
      {comicNumber === 42 && (
        <img src={comic_42} alt="comic" className="comic" key={"cartoon 42.png"} />
      )}
      {comicNumber === 41 && (
        <img src={comic_41} alt="comic" className="comic" key={"cartoon 41.png"} />
      )}
      {comicNumber === 40 && (
        <img src={comic_40} alt="comic" className="comic" key={"cartoon 40.png"} />
      )}
      {comicNumber === 39 && (
        <img src={comic_39} alt="comic" className="comic" key={"cartoon 39.png"} />
      )}
      {comicNumber === 38 && (
        <img src={comic_38} alt="comic" className="comic" key={"cartoon 38.png"} />
      )}
      {comicNumber === 37 && (
        <img src={comic_37} alt="comic" className="comic" key={"cartoon 37.png"} />
      )}
      {comicNumber === 36 && (
        <img src={comic_36} alt="comic" className="comic" key={"cartoon 36.png"} />
      )}
      {comicNumber === 35 && (
